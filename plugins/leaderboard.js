...
━━━━━━━━━━━━━━━━━━━━
${sortedExp.slice(0, len).map(([user, data], i) => (i + 1) + '. wa.me/' + user.split`@`[0] + ': *' + data.exp + ' XP*').join`\n`}
━━━━━━━━━━━━━━━━━━━━
• *Money Leaderboard Top ${len}* •
Kamu: *${usersmoney.indexOf(m.sender) + 1}* dari *${usersmoney.length}*
━━━━━━━━━━━━━━━━━━━━
${sortedmoney.slice(0, len).map(([user, data], i) => (i + 1) + '. wa.me/' + user.split`@`[0] + ': *' + data.money + ' Money*').join`\n`}
━━━━━━━━━━━━━━━━━━━━
• *Limit Leaderboard Top ${len}* •
Kamu: *${usersLim.indexOf(m.sender) + 1}* dari *${usersLim.length}*
━━━━━━━━━━━━━━━━━━━━
${sortedLim.slice(0, len).map(([user, data], i) => (i + 1) + '. wa.me/' + user.split`@`[0] + ': *' + data.limit + ' Limit*').join`\n`}
━━━━━━━━━━━━━━━━━━━━
`.trim()
